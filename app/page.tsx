    ...
    <main className="relative h-screen w-full overflow-hidden flex flex-col">
      ...
      <nav className="absolute top-0 left-0 w-full flex justify-between items-center px-24 py-6 bg-transparent z-10">
        ...
        <div className="flex gap-4">
          ...
          <button onClick={handleSignIn} className="bg-white font-black px-5 py-2 rounded-lg transition-all duration-200 hover:bg-opacity-80 hover:transform hover:scale-105">Sign in</button>
        </div>
      </nav>
